...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-[#E91E8C] text-white shadow hover:bg-[#c9196f] active:scale-95 focus-visible:ring-[#E91E8C]",
        destructive:
          "bg-red-500 text-white shadow-sm hover:bg-red-600 focus-visible:ring-red-500",
        outline:
          "border border-[#E91E8C] text-[#E91E8C] bg-transparent hover:bg-[#E91E8C] hover:text-white focus-visible:ring-[#E91E8C]",
        secondary:
        ...
        link: "text-[#E91E8C] underline-offset-4 hover:underline focus-visible:ring-[#E91E8C]",
      },
      size: {
