...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var hashedPassword, admin, categories, _i, categories_1, cat;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    console.log("🌱 Seeding database...");
                    return [4 /*yield*/, bcryptjs_1.default.hash("Admin@1234", 12)];
                case 1:
                ...
                case 2:
                    admin = _a.sent();
                    console.log("\u2705 Admin created: ".concat(admin.email));
                    categories = [
                ...
                case 5:
                    ...
                    return [3 /*break*/, 3];
                case 6:
                    console.log("\u2705 ".concat(categories.length, " categories created"));
                    console.log("\n🎉 Seeding complete!");
